package com.ristorantemonopoli.backend.config;
...
import com.ristorantemonopoli.backend.database.repository.impl.CustomRepositoryImpl;

@Configuration
@EnableJpaRepositories(basePackages = {"com.ristorantemonopoli.backend.database.repository"}, repositoryBaseClass = CustomRepositoryImpl.class)
@EnableTransactionManagement
@ComponentScan(basePackages = { "com.ristorantemonopoli.backend.database" })
@EntityScan("com.ristorantemonopoli.backend.database.entity")
	   ...
	   @Value("${spring.datasource.validationQuery:SELECT 1}")
	    ...
	    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
	        ...
	        return builder
	                ...
	                .packages("com.ristorantemonopoli.backend.database.entity")
	                .persistenceUnit("db")
	                .build();
	    }
