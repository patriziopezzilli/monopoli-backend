...
import com.ristorantemonopoli.backend.constants.SecurityConstants;
import com.ristorantemonopoli.backend.security.filters.JWTAuthenticationFilter;
import com.ristorantemonopoli.backend.security.filters.JWTAuthorizationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().and().authorizeRequests().requestMatchers(EndpointRequest.toAnyEndpoint())
